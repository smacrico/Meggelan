#!/usr/bin/env python3
"""
garmin_hrv_batch_analysis_v5.py
...
Usage:
    python garmin_hrv_batch_analysis_v5.py input_folder --config athlete_config.json
    python garmin_hrv_batch_analysis_v5.py input_folder --config athlete_config.json --athlete stelios
"""
...
def is_hrv_btb_field(field_name: str) -> bool:
    """
    Match Garmin developer-field names for beat-to-beat HRV intervals.
